...
def adjust_codes(file_to_adjust):
    ...
    for idx, code in enumerate(codes):
        if idx > 0:
            ...
            print('-----------------------------')
            print(old_beef)
            code_data = old_beef[81:113] + old_beef[114:170]
            recorded_checksum = old_beef[170:178]
            ...
            mid_beef = old_beef[0:114] + '00000001000000000000000000000001000000000000000000000000'
            code_data = mid_beef[81:113] + mid_beef[114:170]
            calculated_checksum = calc_checksum_carrier(code_data)
            new_beef = mid_beef + calculated_checksum + '2000000001010000000000000000000000001000000000000101100004'
            print(new_beef)
            code['Data'] = new_beef
