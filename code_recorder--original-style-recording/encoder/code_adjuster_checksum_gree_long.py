...
def adjust_codes(file_to_adjust):
    ...
    for idx, code in enumerate(codes):
        if idx > 0:
            ...
            print('-----------------------------')
            print(old_beef)
            code_data = old_beef[73:137]
            recorded_checksum = old_beef[137:141]
            calculated_checksum = calc_checksum(code_data)
            if str(recorded_checksum) != str(calculated_checksum):
                print('ERROR!!!!!!!!!!!!!!!!!!!')

            new_beef = old_beef[0:94] + '0' + old_beef[95:164] + '0' + old_beef[165:]
            print(new_beef)
            calculated_checksum = calc_checksum(new_beef[73:137])
            new_beef = new_beef[0:137] + calculated_checksum + new_beef[141:]
            print(new_beef)
            code['Data'] = new_beef
